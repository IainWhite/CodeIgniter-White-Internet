...
{'Contact'|helper:'page':'headline'}

<script language="text/javascript" type="text/javascript" src="{$base_url}js/modules/home/contact.js"></script>
<div class="row">
    <div class="col-lg-12 col-md-12" id="error">
