...
{'IBM PC AT'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p>The <strong>IBM Personal Computer AT</strong>, more commonly known as the <strong>IBM AT</strong> and also sometimes called the <strong>PC AT</strong> or <strong>PC/AT</strong>, was IBM's second-generation PC, designed around the 6MHz Intel {'80286'|link_urls:'i'} microprocessor and released in 1984 as System Unit 5170.</p>
        ...
        <ul>
            ...
            <li>Early ATs (1984 – 1986) could be equipped with {'CGA'|link_urls:'i'}, {'MDA'|link_urls:'i'}, {'EGA'|link_urls:'i'}, or {'PGC'|link_urls:'i'} video cards.</li>
            ...
            <li>{'PC DOS'|link_urls:'i'} 3.0 was released to support the new AT features, including preliminary kernel support for networking (which was fully supported in a later version 3.x release.)</li>
            ...
            <li>Just like its {'IBM PC'|link_urls:'i'} predecessor, the PC AT supported an optional math co-processor chip, the Intel 80287, for faster execution of floating point operations.</li>
        </ul>
    </div>
</div>
