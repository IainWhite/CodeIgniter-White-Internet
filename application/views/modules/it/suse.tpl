...
{'SUSE'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        {'SUSE'|helper:'page':'getLogo':'m':'png'}
        <p><strong>SUSE Linux</strong> is a computer operating system. It is built on top of the open source Linux kernel and is distributed with system and application software from other open source projects. SUSE Linux is of German origin and mainly developed in Europe.</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <h3>YaST</h3>
        <p><strong>YaST</strong> (<strong>Y</strong>et <strong>a</strong>nother <strong>S</strong>etup <strong>T</strong>ool) is a {'Linux'|link_urls:'i'} operating system setup and configuration tool that is featured in the openSUSE Linux distribution, as well as SUSE's derived commercial distributions.</p>
