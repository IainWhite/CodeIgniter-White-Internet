...
{'IBM Personal Computer'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>The IBM Personal Computer</strong>, commonly known as the <strong>IBM PC</strong>, is the original version and progenitor of the {'IBM PC compatible'|link_urls:'i'} hardware platform.</p>
        <p>It is {'IBM'|link_urls:'/c'} model number 5150, and was introduced on 12 August 1981.</p>
        ...
        <p>The generic term "<em>personal computer</em>" (<strong>PC</strong>) was in use before 1981, applied as early as 1972 to the {'Xerox PARC'|link_urls:'/c'}'s {'Alto'|link_urls:'i'}. However, because of the success of the IBM Personal Computer, the term PC came to mean more specifically a desktop microcomputer compatible with IBM's PC products.</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr>
            <td>{'AT'|link_urls:'i'}</td>
            <td>5170</td>
            <td>August 1984</td>
            <td>{'80286'|link_urls:'i'}</td>
