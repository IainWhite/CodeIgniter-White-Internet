...
{'The Cathedral and the Bazaar'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-6 col-md-6 margin-bottom-10">
        <span class="label label-aqua rounded"><strong>Author:</strong> {'Eric S. Raymond'|link_urls:'/p'}</span>
    </div>
    <div class="col-lg-6 col-md-6">
        <span class="pull-right">
            {'3'|helper:'page':'addbookRating'}
        </span>
    </div>
</div>
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>The Cathedral and the Bazaar: Musings on Linux and Open Source by an Accidental Revolutionary</strong> (abbreviated <strong>CatB</strong>) is an essay, and later a book, by {'Eric S. Raymond'|link_urls:'/p'} on software engineering methods, based on his observations of the {'Linux'|link_urls:'i'} kernel development process and his experiences managing an open source project, fetchmail.</p>
        ...
        <p>The essay's central thesis is Raymond's proposition that "<em>given enough eyeballs, all bugs are shallow</em>" (which he terms {"Linus's Law"|link_urls:'m'}): the more widely available the source code is for public testing, scrutiny, and experimentation, the more rapidly all forms of bugs will be discovered.</p>
        ...
        <ol>
            ...
            <li>Plan to throw one [version] away; you will, anyhow. (Copied from {'Fred Brooks'|link_urls:'/p'}' {'The Mythical Man Month'|link_urls:'/b'})</li>
            ...
            <li>Perfection (in design) is achieved not when there is nothing more to add, but rather when there is nothing more to take away. (Attributed to Antoine de Saint-Exup[é]ry)</li>
