...
{'The Mythical Man-Month'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-6 col-md-6 margin-bottom-10">
        <span class="label label-aqua rounded"><strong>Author:</strong> {'Fred Brooks'|link_urls:'/p'}</span>
    </div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        {'9780201835953'|helper:'page':'addBookCover'}
        <p><strong>The Mythical Man-Month: Essays on Software Engineering</strong> is a book on software engineering and project management by {'Fred Brooks'|link_urls:'/p'}, whose central theme is that <em>"adding manpower to a late software project makes it later"</em>.
        <p>This idea is known as {"Brooks's Law"|link_urls:'m'}, and is presented along with the <strong>second-system effect</strong> and advocacy of prototyping.</p>
        <p>Brooks' observations are based on his experiences at {"IBM"|link_urls:'/c'} while managing the development of OS/360. He had added more programmers to a project falling behind schedule, a decision that he would later conclude had, counter-intuitively, delayed the project even further.</p>
        ...
        {{$smarty.template}|helper:'page':'doMore':'/b'}
    </div>
</div>
...
{if $page->sub == FALSE}
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <h3>The Tendency Towards Irreducible Number of Errors</h3>
            ...
            <h3>Code Freeze and System Versioning</h3>
            ...
            <h3>Lowering Software Development Costs</h3>
...
<div class="row">
    <div class="pull-rightcol-lg-12 col-md-12 margin-bottom-10">
        {'9780201835953'|helper:'page':'addBuyBook'}
