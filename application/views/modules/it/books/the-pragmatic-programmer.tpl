...
{'The Pragmatic Programmer: From Journeyman to Master'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-6 col-md-6 margin-bottom-10">
        <span class="label label-aqua rounded"><strong>Authors:</strong> {'Andy Hunt'|link_urls:'/p'} and {'Dave Thomas'|link_urls:'/p'}</span>
    </div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">    
        {$page->headline}
        {'9780201616224'|helper:'page':'addBookCover'}
...
<div class="row">
    <div class="pull-rightcol-lg-12 col-md-12 margin-bottom-10">
        {'9780201616224'|helper:'page':'addBuyBook'}
