...
{'Analytical Engine'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p>The <strong>Analytical Engine</strong> was a proposed mechanical general-purpose computer designed by English mathematician {'Charles Babbage'|link_urls:'/p'}.</p>
        <p>It was first described in 1837 as the successor to Babbage's {'Difference Engine'|link_urls:'i'}, a design for a mechanical computer.</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>The programming language to be employed by users was akin to modern day assembly languages. Loops and conditional branching were possible, and so the language as conceived would have been Turing-complete as later defined by {'Alan Turing'|link_urls:'/p'}.</p>
        ...
        <p>In 1843, the description was translated into English and extensively annotated by {'Ada Lovelace'|link_urls:'/p'}, who had become interested in the engine eight years earlier.</p>
