...
{'HSL and HSV '|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>HSL</strong> and <strong>HSV</strong> are the two most common cylindrical-coordinate representations of points in an {'RGB'|link_urls:'i'} colour model.</p>
        ...
        <p>HSL (L for lightness) and HSV or HSB (V for value or B for brightness). A third model, HSI (I for intensity), common in computer vision applications, attempts to balance the advantages and disadvantages of the other two systems.</p>
