...
{'The Computer Science Network (CSNET)'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>Its purpose was to extend networking benefits, for computer science departments at academic and research institutions that could not be directly connected to {'ARPANET'|link_urls:'i'}, due to funding or authorization limitations.</p>
        <p>It played a significant role in spreading awareness of, and access to, national networking and was a major milestone on the path to development of the global {'Internet'|link_urls:'i'}.</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>CSNET was a forerunner of the <strong>National Science Foundation Network</strong> ({'NSFNet'|link_urls:'i'}) which eventually became a backbone of the Internet.</p>
