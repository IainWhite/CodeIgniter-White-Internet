...
{'PC-DOS'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        {'PC-DOS'|helper:'page':'getLogo':'m':'png'}
        <p><strong>IBM PC DOS</strong> (The IBM Personal Computer Disk Operating System) is a {'DOS'|link_urls:'i'} system for the {'IBM Personal Computer'|link_urls:'i'} and compatibles, manufactured and sold by {'IBM'|link_urls:'/c'} from the 1980s to the 2000s. From its inception until 1993, PC DOS was a rebranded version of Microsoft {'MS-DOS'|link_urls:'i'}.</p>
        <p>The IBM task force assembled to develop the PC decided that critical components of the machine, including the operating system, would come from outside vendors. This radical break from company tradition of in-house development was the key decision that made the IBM PC an industry standard. But it was done out of necessity, to save time. Microsoft was selected for the operating system.</p>
