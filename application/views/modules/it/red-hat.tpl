...
{'Red Hat Linux'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        {'Red Hat'|helper:'page':'getLogo':'m':'png'}
        <p><strong>Red Hat Linux</strong> (<strong>RHL</strong>), assembled by the company <strong>Red Hat</strong>, was a popular {'Linux'|link_urls:'i'} based operating system until its discontinuation in 2004.</p>
        <p>Early releases of Red Hat Linux were called <strong>Red Hat Commercial Linux</strong>. Red Hat first published the software on 3 November 3, 1994. It was the first Linux distribution to use the <strong>RPM</strong> Package Manager as its packaging format, and over time has served as the starting point for several other distributions, such as <strong>Mandriva Linux</strong> and <strong>Yellow Dog Linux</strong>.</p>
        <p>Red Hat discontinued the Red Hat Linux line in favor of {'Red Hat Enterprise Linux'|link_urls:'i'} (<strong>RHEL</strong>) for enterprise environments. {'Fedora'|link_urls:'i'}, developed by the community-supported <strong>Fedora Project</strong> and sponsored by Red Hat, is the free version best suited for home use. Red Hat Linux 9, the final release, hit its official end-of-life on 30 April 2004.</p>
    </div>
</div>
{if $page->sub == FALSE}
<div class="row">
    <div class="col-lg-12 col-md-12">
        <h3>Red Hat Linux Versions</h3>
...
{include file='modules/it/fedora.tpl'}
{include file='modules/it/red-hat-enterprise-linux.tpl'}
{/if}