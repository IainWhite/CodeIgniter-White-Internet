...
{'RGB Colour Model'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>Typical RGB output devices are TV sets of various technologies (CRT, LCD, plasma, etc.), computer and mobile phone displays, video projectors, multicolour LED displays, and large screens such as JumboTron.</p>
        <p>Colour printers, on the other hand, are not RGB devices, but subtractive colour devices (typically {'CMYK'|link_urls:'i'} colour model).</p>
