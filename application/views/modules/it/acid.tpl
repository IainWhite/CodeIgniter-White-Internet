...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>In a relational database, for instance, once a group of {'SQL'|link_urls:'w'} statements execute, the results need to be stored permanently (even if the database crashes immediately thereafter).</p>
