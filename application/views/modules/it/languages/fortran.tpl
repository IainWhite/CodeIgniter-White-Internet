...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>Originally developed by {'IBM'|link_urls:'/c'} in the 1950s for scientific and engineering applications, Fortran came to dominate this area of programming early on and has been in continuous use for over half a century in computationally intensive areas such as numerical weather prediction, finite element analysis, computational fluid dynamics, computational physics and computational chemistry.</p>
        ...
        <p>Because the capitalisation was never completely consistent in actual usage, this article adopts the convention of using the all-caps FORTRAN in referring to versions of the language up to FORTRAN 77 and the title-caps Fortran in referring to versions of the language from Fortran 90 onward. This convention is reflected in the capitalisation of FORTRAN in the {'ANSI'|link_urls:'/c'} X3.9-1966 (FORTRAN 66) and ANSI X3.9-1978 (FORTRAN 77) standards and the title caps Fortran in the ANSI X3.198-1992 (Fortran 90), ISO/IEC 1539-1:1997 (Fortran 95) and ISO/IEC 1539-1:2004 (Fortran 2003) standards.</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <p>In late 1953, {'John Backus'|link_urls:'/p'} submitted a proposal to his superiors at IBM to develop a more practical alternative to {'assembly language'|link_urls:'/l'} for programming their IBM 704 mainframe computer.</p>
