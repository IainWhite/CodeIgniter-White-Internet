...
{'reactive-programing'|helper:'page':'setBreadcrumb'}
{'Reactive Manifesto'|helper:'page':'headline'}
<div class="row">
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>The <strong>Reactive Manifesto</strong> {'www.reactivemanifesto.org'|link_urls:'x':'www.reactivemanifesto.org/'}.</p>
    </div>
</div>
{/if}