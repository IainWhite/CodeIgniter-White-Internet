...
{'Fedora'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        {'Fedora'|helper:'page':'getLogo':'m':'png'}
        <p><strong>Fedora</strong>, formerly <strong>Fedora Core</strong>, is an RPM-based, general purpose collection of software, including an operating system based on the {'Linux'|link_urls:'i'} kernel, developed by the community-supported <strong>Fedora Project</strong> and owned by <strong>Red Hat</strong>.</p>
        ...
        <p>The Fedora Project was created in late 2003, when <strong>Red Hat Linux</strong> was discontinued. {'Red Hat Enterprise Linux'|link_urls:'i'} was to be Red Hat's only officially supported Linux distribution, while Fedora was to be a community distribution. Red Hat Enterprise Linux branches its releases from versions of Fedora.</p>
    </div>
</div>
{if $page->sub == FALSE}
<div class="row">
    <div class="col-lg-12 col-md-12">
        <h3>Fedora Versions</h3>
