...
{'Y2k - The Millennium Bug'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>In 1997, The <strong>British Standards Institute</strong> (<strong>BSI</strong>) developed a standard, DISC PD2000-1, which defines "Year 2000 Conformity requirements" as four rules:</p>
        <ol>
