{{$smarty.template}|helper:'page':'registerTemplate':'it'}
        {'ySlow'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        {'ySlow'|helper:'page':'getLogo':'m':'png':'right'}
        ...
        <ul>
            ...
            <li>Provides tools for performance analysis, including <strong>Smush.it</strong> and {'JSLint'|link_urls:'w'}.</li>
        </ul>

        <h3>Web Performance Best Practices and Rules</h3>
        ...
        <p><strong>Official ySlow page:</strong> {'developer.yahoo.com/yslow/'|link_urls:'x':'http://developer.yahoo.com/yslow//'}</p>
    </div>
</div>
