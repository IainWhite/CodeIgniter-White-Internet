...
{'CGI - Common Gateway Interface'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>CGI, when implemented on a {'web server'|link_urls:'w'}, provides an interface between the web server and programs that generate the web content.</p>
        ...
        <p>In 1993, the {'World Wide Web'|link_urls:'w'} was small but flourishing. WWW software developers and Web site developers kept in touch on the <strong>www-talk mailing list</strong>, so it was there that a standard for calling command line executables was agreed upon.</p>
        ...
        <p>A work group chaired by Ken Coar started in November 1997 to get the NCSA definition of CGI more formally defined. This work resulted in {'3875'|link_urls:'rfc'}, which specified CGI Version 1.1.</p>
        ...
        <ul>
            ...
            <li><strong>Ari Luotonen</strong> (the developer of the {'CERN'|link_urls:'/c'} httpd Web server)</li>
