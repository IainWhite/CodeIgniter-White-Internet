...
{'Puppet'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>Puppet</strong> is an open source configuration management utility.</p>
        <p>It runs on many {'Unix'|link_urls:'i'}-like systems as well as on {'Microsoft Windows'|link_urls:'i'}, and includes its own declarative language to describe system configuration.</p>
        <p>Puppet is produced by <strong>Puppet Labs</strong>, founded by <strong>Luke Kanies</strong> in 2005. It is written in {'Ruby'|link_urls:'/l'} and released as free software under the GPL until version 2.7.0 and the Apache 2.0 license after that.</p>
