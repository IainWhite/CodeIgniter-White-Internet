...
{'IIS - Internet Information Server'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>Internet Information Services</strong> (<strong>IIS</strong>, formerly <strong>Internet Information Server</strong>) is an extensible {'web server'|link_urls:'w'} created by {'Microsoft'|link_urls:'/c'} for use with {'Windows NT'|link_urls:'i'} family.</p>
        <p>IIS supports {'HTTP'|link_urls:'w'}, {'HTTPS'|link_urls:'w'}, {'FTP'|link_urls:'w'}, {'SMTP'|link_urls:'w'} and {'NNTP'|link_urls:'w'}.</p>
