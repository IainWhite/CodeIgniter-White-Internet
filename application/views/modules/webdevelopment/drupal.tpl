...
{'Drupal'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        {'Drupal'|helper:'page':'getLogo':'m':'png'}
        <p><strong>Drupal</strong> is a free and open-source content-management framework written in {'PHP'|link_urls:'/l'} and distributed under the GNU General Public License.</p>
        <p>It is used as a back-end framework for at least 2.1% of all Web sites worldwide ranging from personal blogs to corporate, political, and government sites including {'WhiteHouse.gov'|link_urls:'x':'http://www.whitehouse.gov'} and {'data.gov.uk'|link_urls:'x':'http://data.gov.uk'}. It is also used for knowledge management and business collaboration.</p>
        ...
        <p>Drupal runs on any computing platform that supports both a Web server capable of running PHP (including {'Apache'|link_urls:'w'}, {'IIS'|link_urls:'w'}, {'Lighttpd'|link_urls:'w'}, {'Hiawatha'|link_urls:'w'}, {'Cherokee'|link_urls:'w'} or {'Nginx'|link_urls:'w'}) and a database (such as {'MySQL'|link_urls:'w'}, {'MongoDB'|link_urls:'w'}, {'MariaDB'|link_urls:'w'}, {'PostgreSQL'|link_urls:'w'}, {'SQLite'|link_urls:'w'}, or {'MS SQLServer'|link_urls:'w'}) to store content and settings.</p>
        ...
        <p>As of 2014 Drupal is developed by a community, and its popularity is growing rapidly. From July 2007 to June 2008 the {'Drupal.org'|link_urls:'x':'http://drupal.org'} site provided more than 1.4 million downloads of Drupal software, an increase of approximately 125% from the previous year.</p>
        ...
        <br />
        <p><strong>Official Drupal website:</strong> {'Drupal.org'|link_urls:'x':'http://drupal.org'}</p>
    </div>
</div>
{if $page->sub == FALSE}
<div class="row">
    <div class="col-lg-12 col-md-12">
        <h2>Major Drupal Versions</h2>
