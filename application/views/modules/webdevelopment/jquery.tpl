...
{'jQuery'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>jQuery</strong> is a cross-platform {'JavaScript'|link_urls:'/l'} library designed to simplify the client-side scripting of {'HTML'|link_urls:'w'}.</p>
        ...
        <p>jQuery's syntax is designed to make it easier to navigate a document, select {'DOM'|link_urls:'w'} elements, create animations, handle events, and develop {'AJAX'|link_urls:'w'} applications.</p>
        ...
        <p>The set of jQuery core features—DOM element selections, traversal and manipulation—enabled by its selector engine (named "<strong>Sizzle</strong>" from v1.3), created a new "programming style", fusing algorithms and DOM-data-structures; and influenced the architecture of other JavaScript frameworks like {'YUI'|link_urls:'w'} v3 and {'Dojo'|link_urls:'w'}.</p>
        <p>{'Microsoft'|link_urls:'/c'} and Nokia bundle jQuery on their platforms. Microsoft includes it with {'Visual Studio'|link_urls:'i'} for use within Microsoft's ASP.NET AJAX framework and ASP.NET MVC Framework while Nokia has integrated it into the Web Run-Time widget development platform.</p>
        <p>jQuery has also been used in {'MediaWiki'|link_urls:'w'} since version 1.16.</p>
    </div>
</div>
{if $page->sub == FALSE}
<div class="row">
