...
{'styling'|helper:'page':'setBreadcrumb'}
{'CSS - Cascading Style Sheets'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12"> 
        ...
        <p>While most often used to style web pages and interfaces written in {'HTML'|link_urls:'w'} and {'XHTML'|link_urls:'w'}, the language can be applied to any kind of XML document, including plain {'XML'|link_urls:'w'}, {'SVG'|link_urls:'w'} and {'XUL'|link_urls:'w'}.</p>
        ...
        <p>The CSS specifications are maintained by the World Wide Web Consortium ({'W3C'|link_urls:'/c'}).</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <p>The first instance of what later came to be CSS, was in {'Tim Berners-Lee'|link_urls:'/p'}'s {'NeXT'|link_urls:'i'} browser/editor. The browser was developed in such a way that the style of document could be separated and defined in a simple style sheet.</p>
        <p>Style sheets have existed in one form or another since the beginnings of <strong>Standard Generalized Markup Language ({'SGML'|link_urls:'w'})</strong> in the 1980s.</p>
        ...
        <p>Variations in web browser implementations, such as {'ViolaWWW'|link_urls:'w'} and {'WorldWideWeb'|link_urls:'w'}, made consistent site appearance difficult, and users had less control over how web content was displayed.</p>
        <p>{'Robert Calliau'|link_urls:'/p'} wanted to separate the structure from the presentation.</p>
        ...
        <p>In August 1996 Netscape Communication Corporation presented an alternative style sheet language called <strong>JavaScript Style Sheets ({'JSSS'|link_urls:'w'})</strong>. The spec was never finished and is deprecated.</p>
