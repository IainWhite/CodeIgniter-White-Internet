...
{'Web Accessibility'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>For example, when a site is coded with semantically meaningful {'HTML'|link_urls:'w'}, with textual equivalents provided for images and with links named meaningfully, this helps blind users using text-to-speech software and / or text-to-Braille hardware.</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p><strong>Web Content Accessibility Guidelines (WCAG)</strong> are part of a series of web accessibility guidelines published by the <strong>Web Accessibility Initiative ({'WAI'|link_urls:'/c'})</strong> of the <strong>World Wide Web Consortium's ({'W3C'|link_urls:'/c'})</strong>, the main international standards organization for the {'World Wide Web'|link_urls:'w'}.</p>
        ...
        <p><strong>WCAG 2.0:</strong> {'http://www.w3.org/TR/WCAG20/'|link_urls:'x':'www.w3.org/TR/WCAG20/'}</p>
    </div>
</div>
{/if}