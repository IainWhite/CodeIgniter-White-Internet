...
{'WordPress'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>WordPress</strong> is a free and open source blogging tool and a content management system ({'CMS'|link_urls:'w'}) based on {'PHP'|link_urls:'/l'} and {'MySQL'|link_urls:'w'}.</p>
        ...
        <br />
        <p><strong>Official WordPress website:</strong> {'WordPress.org'|link_urls:'x':'https://wordpress.org/'}</p>
    </div>
</div>
{if $page->sub == FALSE}
<div class="row">
