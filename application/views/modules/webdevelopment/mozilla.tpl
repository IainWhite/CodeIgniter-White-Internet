...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>Its development was initiated by {'Netscape'|link_urls:'/c'} Communications Corporation, before their acquisition by {'AOL'|link_urls:'/c'}.</p>
        <p>It was based on the source code of {'Netscape Communicator'|link_urls:'w'}.</p>
        <p>The development was spearheaded by the <strong>Mozilla Organization</strong> from 1998 to 2003, and by the {'Mozilla Foundation'|link_urls:'/c'} from 2003 to 2006.</p>
        <p>It has been superseded by <strong>{'SeaMonkey'|link_urls:'w'} Internet suite</strong> (<em>SeaMonkey</em> was the original code name for the project), a community-driven Internet suite that is based on the same source code and continued to be developed with newer Mozilla codebase.</p>
        ...
        <p>Also included were tools to synchronise the application with <strong>Palm Pilot</strong> devices, and several extensions for advanced Web development including the <strong>{'DOM'|link_urls:'w'} Inspector</strong> and {'Venkman'|link_urls:'w'} (a {'JavaScript'|link_urls:'/l'} debugger).</p>
        <p>Versions 6 and 7 of the Netscape suite were based on the Mozilla Suite.</p>
        <p>The last official version is 1.7.13, as Mozilla Foundation is now focusing on the development of {'Firefox'|link_urls:'w'} and {'Thunderbird'|link_urls:'i'}.</p>
    </div>
</div>
{if $page->sub == FALSE}
<div class="row">
