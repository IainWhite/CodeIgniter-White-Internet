...
{'Trident Layout Engine'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>Trident</strong> (also known as <strong>MSHTML</strong>) is the name of the {'layout engine'|link_urls:'w'} for the {'Microsoft Windows'|link_urls:'i'} version of {'Internet Explorer'|link_urls:'w'}.</p>
        ...
        <p>For versions 7 and 8 of Internet Explorer, {'Microsoft'|link_urls:'/c'} made significant changes to the Trident layout engine to improve compliance with web standards and add support for new technologies.</p>
