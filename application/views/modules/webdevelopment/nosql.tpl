...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>The data structure (e.g. key-value, graph, or document) differs from the {'RDBMS'|link_urls:'w'}, and therefore some operations are faster in NoSQL and some in RDBMS.</p>
        ...
        <p>NoSQL systems are also referred to as "Not only SQL" to emphasize that they may in fact allow {'SQL'|link_urls:'w'} like query languages to be used.</p>
        <p>Many NoSQL stores compromise consistency (in the sense of the {'CAP theorem'|link_urls:'m'}) in favour of availability and partition tolerance.</p>
