...
{'Google Chrome'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        {'Google Chrome'|helper:'page':'getLogo':'m':'png'}
        <p><strong>Google Chrome</strong> is a freeware {'web browser'|link_urls:'w'} developed by {'Google'|link_urls:'/c'}.</p>
        <p>It used the {'WebKit'|link_urls:'w'} layout engine until version 27 and, with the exception of its {'iOS'|link_urls:'i'} releases, from version 28 and beyond uses the WebKit fork Blink.</p>
        <p>It was first released as a beta version for {'Microsoft Windows'|link_urls:'i'} on 2 September 2008, and as a stable public release on 11 December 2008.</p> 
    </div>
</div>
{if $page->sub == FALSE}
<div class="row">
...
<td>Blink 537.36<br />
<abbr title="iOS">WebKit 537.51.1 (on iOS)</abbr></td>
<td>3.23.17.13</td>
<td>
<ul>
