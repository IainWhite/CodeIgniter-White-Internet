...
{'Microsoft Script Debugger'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p><strong>Microsoft Script Debugger</strong> is relatively minimal debugger for Windows Script Host supported scripting languages, such as {'VBScript'|link_urls:'/l'} and {'JScript'|link_urls:'/l'}.</p>
        ...
        <p>{'Microsoft'|link_urls:'/c'} considers it to be deprecated in favour of the more sophisticated {'Microsoft Script Editor'|link_urls:'i'} (<code>MSE.EXE</code>), an optional tool included in {'Microsoft Office'|link_urls:'i'} 2000 through Office 2007.</p>
        <p>Also, {'Internet Explorer 8'|link_urls:'w'} comes with a different, tightly integrated JScript debugger part of the Internet Explorer Developer Tools.</p>
