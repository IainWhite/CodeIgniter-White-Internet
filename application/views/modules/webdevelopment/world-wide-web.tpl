...
{'The World Wide Web'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p>The <strong>World Wide Web</strong> (abbreviated as <strong>WWW</strong> commonly known as the <strong>web</strong>) is a system of interlinked hypertext documents accessed via the {'Internet'|link_urls:'i'}.</p>
        <p>With a {'web browser'|link_urls:'w'}, one can view web pages that may contain text, images, videos, and other multimedia and navigate between them via hyperlinks.</p>
        <p>On 12 March 1989, {'Tim Berners-Lee'|link_urls:'/p'}, a British computer scientist and former {'CERN'|link_urls:'/c'} employee, wrote a proposal for what would eventually become the World Wide Web.</p>
        ...
        <p>Berners-Lee and Belgian computer scientist {'Robert Cailliau'|link_urls:'/p'} proposed in 1990 to use hypertext "<em>to link and access information of various kinds as a web of nodes in which the user can browse at will</em>", and Berners-Lee finished the first website in December of that year.</p>
        <p>The first test was completed around 20 December 1990 and Berners-Lee reported about the project on the newsgroup alt.hypertext on 7 August 1991.</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>With help from Robert Cailliau, he published a more formal proposal (on 12 November 1990) to build a "Hypertext project" called "<em>WorldWideWeb</em>" (one word) as a "web" of "hypertext documents" to be viewed by "browsers" using a {'client–server'|link_urls:'i'} architecture.</p>
        ...
        <p>While the read-only goal was met, accessible authorship of web content took longer to mature, with the {'wiki'|link_urls:'w'} concept, {'blog'|link_urls:'w'}s, {'Web 2.0'|link_urls:'w'} and {'RSS'|link_urls:'w'}.</p>
        ...
        <p>A {'NeXT'|link_urls:'i'} Computer was used by Berners-Lee as the world's first {'web server'|link_urls:'w'} and also to write the first {'web browser'|link_urls:'w'}, {'WorldWideWeb'|link_urls:'w'}, in 1990.</p>
