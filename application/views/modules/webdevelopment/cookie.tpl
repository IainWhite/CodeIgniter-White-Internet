...
{'HTTP Cookie'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>Security vulnerabilities may allow a cookie's data to be read by a hacker, used to gain access to user data, or used to gain access (with the user's credentials) to the website to which the cookie belongs (e.g. {'cross-site scripting'|link_urls:'w'} and {'cross-site request forgery'|link_urls:'w'}).</p>
    </div>
</div>