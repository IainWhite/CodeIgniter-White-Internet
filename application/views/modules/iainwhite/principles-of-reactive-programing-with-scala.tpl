...
{'Principles of Reactive Programming with Scala'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p><strong>Leaturer:</strong> {'Erik Meijer'|link_urls:'/p'}, {'Roland Kuhn'|link_urls:'/p'} and {'Martin Odersky'|link_urls:'/p'}</p>
        <p><strong>Date:</strong> November 2013 (7 weeks)</p>
        <p>Seven weeks exploreing reactive programming in a sequence of lectures, quizzes, and homework assignments from {'Erik Meijer'|link_urls:'/p'}, {'Roland Kuhn'|link_urls:'/p'} and {'Martin Odersky'|link_urls:'/p'} the creata of {'Scala'|link_urls:'/l'}.</p>
...
<div class="row">
    ...
    {''|helper:'page':'useMore'}
    {include file='modules/it/reactive-programing.tpl'}
{/if}