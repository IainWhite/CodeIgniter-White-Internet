...
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p class="text-center">Curriculum Vitae for Iain White, Web Development Team Lead and Certified Professional Scrum Master</p>
        <h2>Skills</h2>
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="work-history">
                    ...
                    <div class="funny-boxes funny-boxes-left-green shadow-effect-1">
                        ...
                        <img src="/images/companies/onthehouse.gif" alt="OnTheHouse Logo" title="OnTheHouse" class="pull-right img-bordered" />
                    </div>
                    <div class="funny-boxes funny-boxes-left-green shadow-effect-1">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 align-vmiddle">
                    ...
                    <div class="row">
                     ...
                     <img src="/images/companies/freenet.gif" alt="Freenet Logo" title="Freenet" class="pull-right img-bordered"/>                           
                    <p>Working with ground breaking technology to bring free Internet access to Australia.</p>
                    ...
                    <img src="/images/companies/big-bridge.gif" alt="Big Bridge Logo" title="Big Bridge" class="pull-right img-bordered"/>
                    ...
                    <img src="/images/companies/aot-group-logo.gif" alt="AOT Group Logo" title="AOT Group" class="pull-right img-bordered"/>
                    ...
                    <p>Some highlights form my 5 years with the AOT Group are:</p>
                    <ul>
                        <li>Re-design and development of a last minute accommodation site for SEO.</li>
                        <li>Design and some development to source dynamic property rates from a third party system.</li>
                        <li>Specified and oversaw the third party development of a customer loyalty system called pillowPOINTS.</li>
                        <li>Addition of PayPal as a payment option.</li>
                        <li>Added support for Google Maps.</li>
                        <li>Development of a light weight scaled down booking application for internal use called CCI (Call Centre Interface).</li>
                        <li>Design of a flexible and expandable portal site for internal applications called AOT Central.</li>
                        <li>Design and development of a system of hierarchical booking notes between external Travel Agents and Internal Consultants.</li>
                        <li>Development of an application called Jack that automatically created bookings from a daily CSV file.</li>
                    </ul>
                    <p>As Development Team Leader I had many duties.</p>
                    <ul>
                        <li>Responsible for the eCommerce Development Team (5 staff), reporting to Group General Manager.</li>
                        <li>Producing technical designs</li>
                        <li>Application Architect</li>
                        <li>Developing in PHP 5, JavaScript, XML and ASP (VBScript)</li>
                        <li>Interface between Development Team and management</li>
                        <li>Setter and enforcer of requirements and standards for the Software Development Life Cycle.</li>
                        <li>Miner database administration of PostgreSLQ and MS SQLServer</li>
                        <li>Assisted with XHTML mark-up, CSS and SEO issues</li>
                        <li>Interviewing</li>
                        <li>Mentioning</li>
                        <li>Training</li>
                    ...
                    <img src="/images/companies/jpc-infonet.jpg" alt="JPC Infonet Logo" title="JPC Infonet" class="pull-right img-bordered"/>
                    <p>JPC Infonet is a web development and hosting company. <strong>Corporate site:</strong> <a href="http://www.jpci.net/" class="external" rel="external">www.jpci.net</a></p>
                    <p>Acting manager for the Web Team (3 1/2 staff), reporting to director level.</p>
                    <ul>
                        <li>Developed and maintained web sites for clients such as CapitalOne (mortgages), Crimson Hotel group, Resale-Spain (property) and Yate town council.</li>
                        <li>Arranged workflow and priorities for the entire Web Team.</li>
                        <li>Designed and developed databases and server side applications to use them.</li>
                        <li>Produced sites by hand coding in HTML and JavaScript.</li>
                        <li>Deployed technology as required: ASP, PHP, ColdFusion, Perl etc.</li>
                        <li>Designed web sites and created additional images using Fireworks and Flash.</li>
                        <li>Provided Search Engine Optimisation.</li>
                        <li>Provided training and documentation for web site development, Dreamweaver, PHP, ColdFusion and in-house developed applications.</li>
                        <li>Developed e-commerce applications based on PayPal, WorldPay and Barclays Bank.</li>
                    ...
                    <img src="/images/companies/webeurope.gif" alt="Web Europe Logo" title="Web Europe" class="pull-right img-bordered"/>
                    <ul>
                        ...
                        <li>2 weeks working for <strong>E3 Media</strong>.
                            <ul>
                                <li>Provided additional database and back-end work for the Kia and Proton web sites I had developed at TigerRedi and now managed by E3 Media.</li>
                            </ul>
                        </li>
                    </ul>
                    </div>
                    ...
                    <img src="/images/companies/tigerredi-logo.gif" alt="TigerRedi Logo" title="TigerRedi" class="pull-right img-bordered"/>
                    <p>TigerRedi was a web development company (<em>the company is no longer trading</em>).</p>
                    <ul>
                        <li>Responsible for the Technical Development Team (3 staff), reporting to director level.</li>
                        <li>Developed and maintained web sites for clients such as Kia cars, Proton cars, Teemo Furniture, Honda UK and Nike Europe.</li>
                        <li>Administered both Linux and NT based web servers.</li>
                        <li>Established site navigation and 'look and feel' with Design Team.</li>
                        <li>Arranged workflow and priorities for the entire Technical Team.</li>
                        <li>Designed and developed cross-browser DHTML components, code libraries and APIs.</li>
                        <li>Designed and developed databases and server side scripts to use them, including Content Management Systems, forums, image galleries etc.</li>
                        <li>Produced sites by hand coding in HTML and JavaScript.</li>
                        <li>Deployed technology as required:  ASP, PHP, JSP, Perl, JAVA, and VISUAL BASIC etc.</li>
                    ...
                    <img src="/images/companies/ans.gif" alt="ANS Logo" title="ANS" class="pull-right img-bordered"/>
                    <p>Anglian Network Systems (ANS) provided web sites for small and medium business. I founded this company in 1997 and closed it in 2000.</p>
                    <ul>
                        <li>In September 1999 I started trading as a web development company using the same company that I had founded in 1997 to support my software developer contracting.</li>
                        <li>Designed and created web sites for local companies.</li>
                        <li>Created images using Fireworks, Paint Shop Pro and PhotoShop.</li>
                        <li>Developed site back-ends using server-side scripts to store and retrieve information from databases.</li>
                        <li>Created web sites using Homesite, Dreamweaver and Flash with a strong emphasis on coding by hand using HTML, DHTML and JavaScript.</li>
                        <li>Designed and developed databases and server side scripts to use them.</li>
                        <li>Produced sites by hand coding in HTML and JavaScript.</li>
                    ...
                    <img src="/images/companies/reuters.gif" alt="Reuters Logo" title="Reuters" class="pull-right img-bordered"/>
                    <p>Reuters is a major international news distributor. <strong>Wikipedia page:</strong> <a href="http://en.wikipedia.org/wiki/Reuters" class="external" rel="external">en.wikipedia.org/wiki/Reuters</a></p>
                    <ul>
                        <li>Developed PASCAL programs to add news feeds, in varying formats and languages (including Russian and Chinese) , into the Reuters Business Briefing application.</li>
                        <li>Conducted reviews and millennium compliance certification for programming changes.</li>
                        <li>Developed Content Management Systems to comply with CMM level 2.</li>
                        <li>Assisted in the development of routines to automate the translation of HTML formatted files into the inhouse markup format.</li>
                        <li>Had a lead role in the team responsible for converting all of the department's resources onto the company's Intranet including JavaScript and developing code to access an Oracle database through PHP3.</li>
                    ...
                    <img src="/images/companies/sms.jpg" alt="SMS Logo" title="SMS" class="pull-right img-bordered"/>
                    <p>Shared Medical Systems Nederlands provided IT administrative support to hospitals in the Netherlands.</p>
                    <ul>
                        <li>Provided computer support and development in VAX BASIC &amp; Visual BASIC to hospitals.</li>
                        <li>Incorporated Dutch specific medical insurance rules into existing patient billing systems.</li>
                        <li>Created and administered patient and billing databases for Dutch hospitals.</li>
                        <li>Added additional flexibility to the patient registration process.</li>
                        <li>Manually corrected error and omissions in the financial transaction databases.</li>
                    ...
                    <div class="funny-boxes funny-boxes-left-green shadow-effect-1">
                        ...
                        <img src="/images/companies/eds-logo.gif" alt="EDS Logo" title="EDS" class="pull-right img-bordered"/>
                        <p>EDS Helthcare provided IT administration support to a number of hospitals in England.</p>
                        <ul>
                            <li>Created, distributed and installed MUMPS programs to several hospitals in the South West of England.</li>
                    ...
                    <div class="funny-boxes funny-boxes-left-green shadow-effect-1">
                        ...
                        <p>Radford Group is a manufacturer of supermarket shelving and storage.</p>
                        <ul>
                            <li>Provided system support for DEC VAXs, SUN SPARCs and PCs.</li>
                    ...
                    <div class="funny-boxes funny-boxes-left-green shadow-effect-1">
                        ...
                        <p>Mail Marketing is a direct mail advertising company.</p>
                        <ul>
                            <li>Provided system support for two Concurrent mini-computers and several PCs.</li>
                            <li>Developed C programs to read and write TAR format tapes.</li>
                    ...
                    <div class="funny-boxes funny-boxes-left-green shadow-effect-1">
                        ...
                        <img src="/images/companies/clares-logo.gif" alt="Clares Retail Equipment Logo" title="Clares Retail Equipment" class="pull-right img-bordered"/>
                        <p>Clares Retail Equipment is a manufacturer of supermarket shelving and baskets.</p>
                        <ul>
                            <li>Provided computer support and development for IMPCON, a factory floor control system.</li>
                            <li>Developed software in VAX BASIC and COBOL, including a windowing user interface.</li>
                    ...
                    <div class="funny-boxes funny-boxes-left-green shadow-effect-1">
                        ...
                        <img src="/images/companies/bae.gif" alt="BAe Logo" title="BAe" class="pull-right img-bordered"/>        
                        <p>British Aerospace (BAe) is an aircraft manufacture. <strong>Wikipedia page:</strong> <a href="http://en.wikipedia.org/wiki/British_Aerospace" class="external" rel="external">en.wikipedia.org/wiki/British_Aerospace</a></p>
                        <ul>
                            <li>Covered by the Official Secrets Act</li>
                            <li>Line Manager for Computer Aided Manufacture software development (3 1/2 staff) reporting to executive level</li>
                            <li>Developed a full Computer Integrated Manufacturing environment.</li>
                            <li>Developed with VAX FORTRAN and COBOL, and also used C and PASCAL on PCs.</li>
                            <li>Developed custom frontend interfaces for many applications.</li>
                            <li>Designed and administered back-end databases.</li>
                            <li>Designed and administrated security and access control systems.</li>
                            <li>Developed virtual interfaces between both 3<sup>rd</sup> party and in-house applications.</li>
                            <li>Developed inter platform migration and translation software.</li>
                            <li>Developed drives for printers, plotters and punched tape devices.</li>
                            <li>Installed and administered Direct Numeric Control networks.</li>
                            <li>Developed additions to in-house Computer Aided Design system.</li>
                            <li>Represented the Bristol site on 8 national steering groups.</li>
                        </ul>
                    </div>
                    <div class="funny-boxes funny-boxes-left-green shadow-effect-1">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 align-vmiddle">
                                <p class="text-left"><strong>Ferranti Electrical Optical Weapons</strong> 05/1985 - 07/1985 <small>({"01/05/1985"|elapsed:TRUE:TRUE:"30/07/1985"})</small></p>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <h4 class="text-right color-aqua">Student Placement</h4>
                            </div>
                        </div>
                        <img src="/images/companies/ferranti.gif" alt="Ferranti Logo" title="Ferranti" class="pull-right img-bordered"/>
                        <p>Ferranti International plc was a leading manufacturer of tactical laser guidance systems. <strong>Wikipedia page:</strong> <a href="http://en.wikipedia.org/wiki/Ferranti" class="external" rel="external">en.wikipedia.org/wiki/Ferranti</a></p>
                        <ul>
                            <li>Covered by the Official Secrets Act</li>
                            <li>Daily assessment of project progress in clean room.</li>
                            <li>Updating of classified documents and technical drawings.</li>
                            <li>Inventory control.</li>
                            <li>Working with Quality Inspectors.</li>
                        </ul>
                    </div> 
                </div>
