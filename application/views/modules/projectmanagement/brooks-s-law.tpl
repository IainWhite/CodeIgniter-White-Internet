...
{"Brooks's Law"|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>It was coined by {'Fred Brooks'|link_urls:'/p'} in his 1975 book {'The Mythical Man-Month'|link_urls:'/b'}. The corollary of Brooks's Law is that there is an incremental person who, when added to a project, makes it take more, not less time.</p>
