...
{"CAP Theorem"|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>The theorem began as a conjecture made by University of California, Berkeley computer scientist {"Eric Brewer"|link_urls:'/p'} at the 2000 Symposium on Principles of Distributed Computing (PODC).</p>
        ...
        <p>In May 2012 Brewer clarified some of his positions, including why the oft-used "two out of three" concept can be misleading or misapplied, and the different definition of consistency used in CAP relative to the one used in {"ACID"|link_urls:'i'}.</p>
    </div>
</div>
