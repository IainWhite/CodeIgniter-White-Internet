...
{'Lean Software Development'|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        {$page->headline}
        <p>The term <strong>lean software development</strong> originated in the book {'Lean Software Development: An Agile Toolkit'|link_urls:'/b'}, written by {'Mary Poppendieck'|link_urls:'/p'} and {'Tom Poppendieck'|link_urls:'/p'}.</p>
        ...
        <p>The Poppendiecks' involvement in the {'Agile'|link_urls:'m'} software development community, including talks at several Agile conferences has resulted in such concepts being more widely accepted within the Agile community.
