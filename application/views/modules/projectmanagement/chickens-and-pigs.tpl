...
{'The Chicken and the Pig'|helper:'page':'headline'}
<div class="row">
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>The fable is referenced to define two types of project members by the {'Scrum'|link_urls:'m'} agile management system: pigs, who are totally committed to the project and accountable for its outcome, and chickens, who consult on the project and are informed of its progress. By extension, a rooster or gamecock, can be defined as a person who struts around offering uninformed, unhelpful opinions. This analogy is based upon the pig being able to provide bacon (a sacrificial offering, for which the pig must die in order to provide) versus a chicken which provides eggs (non-sacrificial).</p>
