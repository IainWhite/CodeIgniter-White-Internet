...
{"RAD - Rapid Application Development"|helper:'page':'headline'}
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>Rapid application development is a response to processes developed in the 1970s and 1980s, such as the {"Structured Systems Analysis"|link_urls:'m'} and {"Design Method"|link_urls:'m'} and other {"Waterfall"|link_urls:'m'} models.</p>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <ol>
            <li><strong>Requirements Planning phase</strong>  – combines elements of the system planning and systems analysis phases of the <strong>Systems Development Life Cycle</strong> ({"SDLC"|link_urls:'m'}). Users, managers, and IT staff members discuss and agree on business needs, project scope, constraints, and system requirements. It ends when the team agrees on the key issues and obtains management authorization to continue.</li>
