...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <p>ASL is closely related to {"ITIL"|link_urls:'m'}, {"BiSL"|link_urls:'m'} and {"CMM"|link_urls:'m'}. It is described in several books and articles, as well as on the official website of the ASL BiSL Foundation {'www.aslbislfoundation.org'|link_urls:'x':'www.aslbislfoundation.org'}.</p>
